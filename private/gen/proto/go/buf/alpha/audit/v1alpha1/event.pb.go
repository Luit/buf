...
const (
	...
	EventType_EVENT_TYPE_CURATED_PLUGIN_EXECUTION EventType = 23
)
...
var (
	EventType_name = map[int32]string{
		...
		23: "EVENT_TYPE_CURATED_PLUGIN_EXECUTION",
	}
	EventType_value = map[string]int32{
		...
		"EVENT_TYPE_CURATED_PLUGIN_EXECUTION":            23,
	}
)
...
type GenerationRequestSourceType int32

const (
	GenerationRequestSourceType_GENERATION_REQUEST_SOURCE_TYPE_UNSPECIFIED      GenerationRequestSourceType = 0
	GenerationRequestSourceType_GENERATION_REQUEST_SOURCE_TYPE_API              GenerationRequestSourceType = 1
	GenerationRequestSourceType_GENERATION_REQUEST_SOURCE_TYPE_GO_PROXY         GenerationRequestSourceType = 2
	GenerationRequestSourceType_GENERATION_REQUEST_SOURCE_TYPE_NPM_REGISTRY     GenerationRequestSourceType = 3
	GenerationRequestSourceType_GENERATION_REQUEST_SOURCE_TYPE_GENERATE_PLUGINS GenerationRequestSourceType = 4
)

// Enum value maps for GenerationRequestSourceType.
var (
	GenerationRequestSourceType_name = map[int32]string{
		0: "GENERATION_REQUEST_SOURCE_TYPE_UNSPECIFIED",
		1: "GENERATION_REQUEST_SOURCE_TYPE_API",
		2: "GENERATION_REQUEST_SOURCE_TYPE_GO_PROXY",
		3: "GENERATION_REQUEST_SOURCE_TYPE_NPM_REGISTRY",
		4: "GENERATION_REQUEST_SOURCE_TYPE_GENERATE_PLUGINS",
	}
	GenerationRequestSourceType_value = map[string]int32{
		"GENERATION_REQUEST_SOURCE_TYPE_UNSPECIFIED":      0,
		"GENERATION_REQUEST_SOURCE_TYPE_API":              1,
		"GENERATION_REQUEST_SOURCE_TYPE_GO_PROXY":         2,
		"GENERATION_REQUEST_SOURCE_TYPE_NPM_REGISTRY":     3,
		"GENERATION_REQUEST_SOURCE_TYPE_GENERATE_PLUGINS": 4,
	}
)

func (x GenerationRequestSourceType) Enum() *GenerationRequestSourceType {
	p := new(GenerationRequestSourceType)
	*p = x
	return p
}

func (x GenerationRequestSourceType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (GenerationRequestSourceType) Descriptor() protoreflect.EnumDescriptor {
	return file_buf_alpha_audit_v1alpha1_event_proto_enumTypes[3].Descriptor()
}

func (GenerationRequestSourceType) Type() protoreflect.EnumType {
	return &file_buf_alpha_audit_v1alpha1_event_proto_enumTypes[3]
}

func (x GenerationRequestSourceType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use GenerationRequestSourceType.Descriptor instead.
func (GenerationRequestSourceType) EnumDescriptor() ([]byte, []int) {
...
func (x *Event) GetCuratedPluginExecution() *PayloadCuratedPluginExecution {
	if x, ok := x.GetPayload().(*Event_CuratedPluginExecution); ok {
		return x.CuratedPluginExecution
	}
	return nil
}
...
type Event_CuratedPluginExecution struct {
	CuratedPluginExecution *PayloadCuratedPluginExecution `protobuf:"bytes,29,opt,name=curated_plugin_execution,json=curatedPluginExecution,proto3,oneof"`
}
...
func (*Event_CuratedPluginExecution) isEvent_Payload() {}
...
type PayloadCuratedPluginExecution struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// start_time is the time at which plugin execution began.
	StartTime *timestamppb.Timestamp `protobuf:"bytes,1,opt,name=start_time,json=startTime,proto3" json:"start_time,omitempty"`
	// start_time is the time at which plugin execution completed.
	EndTime *timestamppb.Timestamp `protobuf:"bytes,2,opt,name=end_time,json=endTime,proto3" json:"end_time,omitempty"`
	// curated_plugin_id is the id of the curated plugin that was executed.
	CuratedPluginId string `protobuf:"bytes,3,opt,name=curated_plugin_id,json=curatedPluginId,proto3" json:"curated_plugin_id,omitempty"`
	// curated_plugin_name is the name of the curated plugin that was executed.
	CuratedPluginName string `protobuf:"bytes,4,opt,name=curated_plugin_name,json=curatedPluginName,proto3" json:"curated_plugin_name,omitempty"`
	// curated_plugin_version is the version of the curated plugin that was executed.
	CuratedPluginVersion string `protobuf:"bytes,5,opt,name=curated_plugin_version,json=curatedPluginVersion,proto3" json:"curated_plugin_version,omitempty"`
	// repository_id is the id of the repository that the plugin executed against.
	RepositoryId string `protobuf:"bytes,6,opt,name=repository_id,json=repositoryId,proto3" json:"repository_id,omitempty"`
	// repository_owner_id is the id of the owner of the repository that the plugin executed against.
	...
	// request_source represents the type of action that initiated an execution request
	RequestSource GenerationRequestSourceType `protobuf:"varint,8,opt,name=request_source,json=requestSource,proto3,enum=buf.alpha.audit.v1alpha1.GenerationRequestSourceType" json:"request_source,omitempty"`
	// cached is true when the result of a generation request was found in a cache.
	Cached bool `protobuf:"varint,9,opt,name=cached,proto3" json:"cached,omitempty"`
	// trace_id is the ID of the trace associated with the execution, if any.
	TraceId string `protobuf:"bytes,10,opt,name=trace_id,json=traceId,proto3" json:"trace_id,omitempty"`
	// span_id is the ID of the span associated with the execution, if any.
	SpanId string `protobuf:"bytes,11,opt,name=span_id,json=spanId,proto3" json:"span_id,omitempty"`
	// error captures any issues with the generation request
	Error string `protobuf:"bytes,12,opt,name=error,proto3" json:"error,omitempty"`
	// plugin_version_id is the ID of a legacy plugin to be executed.
	PluginVersionId string `protobuf:"bytes,13,opt,name=plugin_version_id,json=pluginVersionId,proto3" json:"plugin_version_id,omitempty"`
	// incoming_image_size is the size of the incoming buf Image in bytes.
	IncomingImageSize int64 `protobuf:"varint,14,opt,name=incoming_image_size,json=incomingImageSize,proto3" json:"incoming_image_size,omitempty"`
	// incoming_image_files is the total number of proto files within the Image.
	IncomingImageFiles int64 `protobuf:"varint,15,opt,name=incoming_image_files,json=incomingImageFiles,proto3" json:"incoming_image_files,omitempty"`
	// generated_code_size is the size of the generated code in bytes.
	GeneratedCodeSize int64 `protobuf:"varint,16,opt,name=generated_code_size,json=generatedCodeSize,proto3" json:"generated_code_size,omitempty"`
	// generated_code_files is the total number of generated files.
	GeneratedCodeFiles int64 `protobuf:"varint,17,opt,name=generated_code_files,json=generatedCodeFiles,proto3" json:"generated_code_files,omitempty"`
	// repository_remote
	RepositoryRemote string `protobuf:"bytes,18,opt,name=repository_remote,json=repositoryRemote,proto3" json:"repository_remote,omitempty"`
	// repository_owner
	RepositoryOwner string `protobuf:"bytes,19,opt,name=repository_owner,json=repositoryOwner,proto3" json:"repository_owner,omitempty"`
	// repository_name
	RepositoryName string `protobuf:"bytes,20,opt,name=repository_name,json=repositoryName,proto3" json:"repository_name,omitempty"`
}

func (x *PayloadCuratedPluginExecution) Reset() {
	*x = PayloadCuratedPluginExecution{}
	if protoimpl.UnsafeEnabled {
...
func (x *PayloadCuratedPluginExecution) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PayloadCuratedPluginExecution) ProtoMessage() {}

func (x *PayloadCuratedPluginExecution) ProtoReflect() protoreflect.Message {
	mi := &file_buf_alpha_audit_v1alpha1_event_proto_msgTypes[26]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PayloadCuratedPluginExecution.ProtoReflect.Descriptor instead.
func (*PayloadCuratedPluginExecution) Descriptor() ([]byte, []int) {
	return file_buf_alpha_audit_v1alpha1_event_proto_rawDescGZIP(), []int{26}
}

func (x *PayloadCuratedPluginExecution) GetStartTime() *timestamppb.Timestamp {
	if x != nil {
		return x.StartTime
	}
	return nil
...
func (x *PayloadCuratedPluginExecution) GetEndTime() *timestamppb.Timestamp {
	if x != nil {
		return x.EndTime
	}
	return nil
...
func (x *PayloadCuratedPluginExecution) GetCuratedPluginId() string {
	if x != nil {
		return x.CuratedPluginId
	}
	return ""
}

func (x *PayloadCuratedPluginExecution) GetCuratedPluginName() string {
	if x != nil {
		return x.CuratedPluginName
	}
	return ""
}

func (x *PayloadCuratedPluginExecution) GetCuratedPluginVersion() string {
	if x != nil {
		return x.CuratedPluginVersion
	}
	return ""
}

func (x *PayloadCuratedPluginExecution) GetRepositoryId() string {
	if x != nil {
		return x.RepositoryId
	}
	return ""
...
func (x *PayloadCuratedPluginExecution) GetRepositoryOwnerId() string {
	if x != nil {
...
func (x *PayloadCuratedPluginExecution) GetRequestSource() GenerationRequestSourceType {
	if x != nil {
		return x.RequestSource
	}
	return GenerationRequestSourceType_GENERATION_REQUEST_SOURCE_TYPE_UNSPECIFIED
}

func (x *PayloadCuratedPluginExecution) GetCached() bool {
	if x != nil {
		return x.Cached
	}
	return false
...
func (x *PayloadCuratedPluginExecution) GetTraceId() string {
	if x != nil {
		return x.TraceId
	}
	return ""
...
func (x *PayloadCuratedPluginExecution) GetSpanId() string {
	if x != nil {
		return x.SpanId
	}
	return ""
...
func (x *PayloadCuratedPluginExecution) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
func (x *PayloadCuratedPluginExecution) GetPluginVersionId() string {
	if x != nil {
...
func (x *PayloadCuratedPluginExecution) GetIncomingImageSize() int64 {
	if x != nil {
		return x.IncomingImageSize
	}
	return 0
}

func (x *PayloadCuratedPluginExecution) GetIncomingImageFiles() int64 {
	if x != nil {
		return x.IncomingImageFiles
	}
	return 0
}

func (x *PayloadCuratedPluginExecution) GetGeneratedCodeSize() int64 {
	if x != nil {
		return x.GeneratedCodeSize
	}
	return 0
}

func (x *PayloadCuratedPluginExecution) GetGeneratedCodeFiles() int64 {
	if x != nil {
		return x.GeneratedCodeFiles
	}
	return 0
}

func (x *PayloadCuratedPluginExecution) GetRepositoryRemote() string {
	if x != nil {
		return x.RepositoryRemote
	}
	return ""
}

func (x *PayloadCuratedPluginExecution) GetRepositoryOwner() string {
	if x != nil {
...
func (x *PayloadCuratedPluginExecution) GetRepositoryName() string {
	if x != nil {
		return x.RepositoryName
	}
	return ""
...
var file_buf_alpha_audit_v1alpha1_event_proto_rawDesc = []byte{
	...
	0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x74, 0x72, 0x61, 0x63, 0x65, 0x49, 0x64, 0x22, 0xbd,
	...
	0x64, 0x70, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x64, 0x12, 0x73,
	0x0a, 0x18, 0x63, 0x75, 0x72, 0x61, 0x74, 0x65, 0x64, 0x5f, 0x70, 0x6c, 0x75, 0x67, 0x69, 0x6e,
	0x5f, 0x65, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x1d, 0x20, 0x01, 0x28, 0x0b,
	...
	0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x48, 0x00, 0x52, 0x16, 0x63, 0x75, 0x72,
	0x61, 0x74, 0x65, 0x64, 0x50, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74,
	0x69, 0x6f, 0x6e, 0x42, 0x09, 0x0a, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x22, 0x1c,
	...
	0x52, 0x09, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0xa9, 0x07, 0x0a, 0x1d,
	0x50, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x43, 0x75, 0x72, 0x61, 0x74, 0x65, 0x64, 0x50, 0x6c,
	0x75, 0x67, 0x69, 0x6e, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x39, 0x0a,
	...
	,
	...
	0x74, 0x6f, 0x72, 0x79, 0x49, 0x64, 0x12, 0x2e, 0x0a, 0x13, 0x72, 0x65, 0x70, 0x6f, 0x73, 0x69,
	0x74, 0x6f, 0x72, 0x79, 0x5f, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x07, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x11, 0x72, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x6f, 0x72, 0x79, 0x4f,
	0x77, 0x6e, 0x65, 0x72, 0x49, 0x64, 0x12, 0x5c, 0x0a, 0x0e, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x5f, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x35,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x53, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x54, 0x79, 0x70, 0x65, 0x52, 0x0d, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x53, 0x6f,
	0x75, 0x72, 0x63, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x63, 0x61, 0x63, 0x68, 0x65, 0x64, 0x18, 0x09,
	0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x63, 0x61, 0x63, 0x68, 0x65, 0x64, 0x12, 0x19, 0x0a, 0x08,
	...
	,
	...
	0x65, 0x18, 0x14, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x72, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74,
	0x6f, 0x72, 0x79, 0x4e, 0x61, 0x6d, 0x65, 0x2a, 0x53, 0x0a, 0x09, 0x41, 0x63, 0x74, 0x6f, 0x72,
	...
	0x59, 0x50, 0x45, 0x5f, 0x53, 0x59, 0x53, 0x54, 0x45, 0x4d, 0x10, 0x02, 0x2a, 0xe3, 0x02, 0x0a,
	...
	0x10, 0x08, 0x2a, 0xb1, 0x07, 0x0a, 0x09, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65,
	...
	0x5f, 0x4c, 0x4f, 0x47, 0x47, 0x45, 0x44, 0x5f, 0x4f, 0x55, 0x54, 0x10, 0x13, 0x12, 0x27, 0x0a,
	0x23, 0x45, 0x56, 0x45, 0x4e, 0x54, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x43, 0x55, 0x52, 0x41,
	0x54, 0x45, 0x44, 0x5f, 0x50, 0x4c, 0x55, 0x47, 0x49, 0x4e, 0x5f, 0x45, 0x58, 0x45, 0x43, 0x55,
	0x54, 0x49, 0x4f, 0x4e, 0x10, 0x17, 0x2a, 0x88, 0x02, 0x0a, 0x1b, 0x47, 0x65, 0x6e, 0x65, 0x72,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x53, 0x6f, 0x75, 0x72,
	0x63, 0x65, 0x54, 0x79, 0x70, 0x65, 0x12, 0x2e, 0x0a, 0x2a, 0x47, 0x45, 0x4e, 0x45, 0x52, 0x41,
	0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x52, 0x45, 0x51, 0x55, 0x45, 0x53, 0x54, 0x5f, 0x53, 0x4f, 0x55,
	...
	,
...
var file_buf_alpha_audit_v1alpha1_event_proto_msgTypes = make([]protoimpl.MessageInfo, 27)
var file_buf_alpha_audit_v1alpha1_event_proto_goTypes = []interface{}{
	...
	(GenerationRequestSourceType)(0),                // 3: buf.alpha.audit.v1alpha1.GenerationRequestSourceType
	...
	(*PayloadRepositoryCommitPushed)(nil),           // 17: buf.alpha.audit.v1alpha1.PayloadRepositoryCommitPushed
	(*PayloadRepositoryContributorAdded)(nil),       // 18: buf.alpha.audit.v1alpha1.PayloadRepositoryContributorAdded
	(*PayloadRepositoryContributorRoleChanged)(nil), // 19: buf.alpha.audit.v1alpha1.PayloadRepositoryContributorRoleChanged
	(*PayloadRepositoryContributorRemoved)(nil),     // 20: buf.alpha.audit.v1alpha1.PayloadRepositoryContributorRemoved
	(*PayloadRepositoryVisibilityChanged)(nil),      // 21: buf.alpha.audit.v1alpha1.PayloadRepositoryVisibilityChanged
	(*PayloadPluginCreated)(nil),                    // 22: buf.alpha.audit.v1alpha1.PayloadPluginCreated
	(*PayloadPluginDeleted)(nil),                    // 23: buf.alpha.audit.v1alpha1.PayloadPluginDeleted
	(*PayloadUserCreated)(nil),                      // 24: buf.alpha.audit.v1alpha1.PayloadUserCreated
	...
	(*PayloadCuratedPluginExecution)(nil),           // 30: buf.alpha.audit.v1alpha1.PayloadCuratedPluginExecution
...
var file_buf_alpha_audit_v1alpha1_event_proto_depIdxs = []int32{
	...
	12, // 11: buf.alpha.audit.v1alpha1.Event.organization_member_removed:type_name -> buf.alpha.audit.v1alpha1.PayloadOrganizationMemberRemoved
	15, // 12: buf.alpha.audit.v1alpha1.Event.repository_created:type_name -> buf.alpha.audit.v1alpha1.PayloadRepositoryCreated
	16, // 13: buf.alpha.audit.v1alpha1.Event.repository_deleted:type_name -> buf.alpha.audit.v1alpha1.PayloadRepositoryDeleted
	17, // 14: buf.alpha.audit.v1alpha1.Event.repository_commit_pushed:type_name -> buf.alpha.audit.v1alpha1.PayloadRepositoryCommitPushed
	18, // 15: buf.alpha.audit.v1alpha1.Event.repository_contributor_added:type_name -> buf.alpha.audit.v1alpha1.PayloadRepositoryContributorAdded
	19, // 16: buf.alpha.audit.v1alpha1.Event.repository_contributor_role_changed:type_name -> buf.alpha.audit.v1alpha1.PayloadRepositoryContributorRoleChanged
	20, // 17: buf.alpha.audit.v1alpha1.Event.repository_contributor_removed:type_name -> buf.alpha.audit.v1alpha1.PayloadRepositoryContributorRemoved
	21, // 18: buf.alpha.audit.v1alpha1.Event.repository_visibility_changed:type_name -> buf.alpha.audit.v1alpha1.PayloadRepositoryVisibilityChanged
	22, // 19: buf.alpha.audit.v1alpha1.Event.plugin_created:type_name -> buf.alpha.audit.v1alpha1.PayloadPluginCreated
	23, // 20: buf.alpha.audit.v1alpha1.Event.plugin_deleted:type_name -> buf.alpha.audit.v1alpha1.PayloadPluginDeleted
	24, // 21: buf.alpha.audit.v1alpha1.Event.user_created:type_name -> buf.alpha.audit.v1alpha1.PayloadUserCreated
	...
	13, // 27: buf.alpha.audit.v1alpha1.Event.idp_group_added:type_name -> buf.alpha.audit.v1alpha1.PayloadOrganizationIDPGroupAdded
	14, // 28: buf.alpha.audit.v1alpha1.Event.idp_group_removed:type_name -> buf.alpha.audit.v1alpha1.PayloadOrganizationIDPGroupRemoved
	30, // 29: buf.alpha.audit.v1alpha1.Event.curated_plugin_execution:type_name -> buf.alpha.audit.v1alpha1.PayloadCuratedPluginExecution
	32, // 30: buf.alpha.audit.v1alpha1.PayloadOrganizationMemberAdded.member_role:type_name -> buf.alpha.registry.v1alpha1.OrganizationRole
	33, // 31: buf.alpha.audit.v1alpha1.PayloadOrganizationMemberAdded.member_role_source:type_name -> buf.alpha.registry.v1alpha1.OrganizationRoleSource
	32, // 32: buf.alpha.audit.v1alpha1.PayloadOrganizationMemberRoleChanged.old_role:type_name -> buf.alpha.registry.v1alpha1.OrganizationRole
	32, // 33: buf.alpha.audit.v1alpha1.PayloadOrganizationMemberRoleChanged.new_role:type_name -> buf.alpha.registry.v1alpha1.OrganizationRole
	33, // 34: buf.alpha.audit.v1alpha1.PayloadOrganizationMemberRoleChanged.old_member_role_source:type_name -> buf.alpha.registry.v1alpha1.OrganizationRoleSource
	33, // 35: buf.alpha.audit.v1alpha1.PayloadOrganizationMemberRoleChanged.new_member_role_source:type_name -> buf.alpha.registry.v1alpha1.OrganizationRoleSource
	32, // 36: buf.alpha.audit.v1alpha1.PayloadOrganizationMemberRemoved.member_role:type_name -> buf.alpha.registry.v1alpha1.OrganizationRole
	33, // 37: buf.alpha.audit.v1alpha1.PayloadOrganizationMemberRemoved.member_role_source:type_name -> buf.alpha.registry.v1alpha1.OrganizationRoleSource
	34, // 38: buf.alpha.audit.v1alpha1.PayloadRepositoryCreated.visibility:type_name -> buf.alpha.registry.v1alpha1.Visibility
	34, // 39: buf.alpha.audit.v1alpha1.PayloadRepositoryDeleted.visibility:type_name -> buf.alpha.registry.v1alpha1.Visibility
	35, // 40: buf.alpha.audit.v1alpha1.PayloadRepositoryContributorAdded.contributor_role:type_name -> buf.alpha.registry.v1alpha1.RepositoryRole
	35, // 41: buf.alpha.audit.v1alpha1.PayloadRepositoryContributorRoleChanged.old_role:type_name -> buf.alpha.registry.v1alpha1.RepositoryRole
	35, // 42: buf.alpha.audit.v1alpha1.PayloadRepositoryContributorRoleChanged.new_role:type_name -> buf.alpha.registry.v1alpha1.RepositoryRole
	35, // 43: buf.alpha.audit.v1alpha1.PayloadRepositoryContributorRemoved.contributor_role:type_name -> buf.alpha.registry.v1alpha1.RepositoryRole
	34, // 44: buf.alpha.audit.v1alpha1.PayloadRepositoryVisibilityChanged.old_visibility:type_name -> buf.alpha.registry.v1alpha1.Visibility
	34, // 45: buf.alpha.audit.v1alpha1.PayloadRepositoryVisibilityChanged.new_visibility:type_name -> buf.alpha.registry.v1alpha1.Visibility
	36, // 46: buf.alpha.audit.v1alpha1.PayloadPluginCreated.visibility:type_name -> buf.alpha.registry.v1alpha1.PluginVisibility
	36, // 47: buf.alpha.audit.v1alpha1.PayloadPluginDeleted.visibility:type_name -> buf.alpha.registry.v1alpha1.PluginVisibility
	31, // 48: buf.alpha.audit.v1alpha1.PayloadCuratedPluginExecution.start_time:type_name -> google.protobuf.Timestamp
	31, // 49: buf.alpha.audit.v1alpha1.PayloadCuratedPluginExecution.end_time:type_name -> google.protobuf.Timestamp
	3,  // 50: buf.alpha.audit.v1alpha1.PayloadCuratedPluginExecution.request_source:type_name -> buf.alpha.audit.v1alpha1.GenerationRequestSourceType
...
func file_buf_alpha_audit_v1alpha1_event_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_buf_alpha_audit_v1alpha1_event_proto_msgTypes[26].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PayloadCuratedPluginExecution); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_buf_alpha_audit_v1alpha1_event_proto_msgTypes[3].OneofWrappers = []interface{}{
		...
		(*Event_CuratedPluginExecution)(nil),
	}
	type x struct{}
